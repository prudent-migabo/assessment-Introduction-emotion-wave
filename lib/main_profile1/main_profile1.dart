...
class MainProfile1 extends StatefulWidget {
  const MainProfile1({super.key, this.index});

  final int? index;

  @override
  State<MainProfile1> createState() => _MainProfile1State();
}

class _MainProfile1State extends State<MainProfile1>
        ...
        builder: (BuildContext context, Widget? child) {
          return Container(
            margin: EdgeInsets.fromLTRB(
                5, height * animationController.value, 5, 0),
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(20),
              image: const DecorationImage(
                  image: AssetImage(Constants.mainImage1), fit: BoxFit.cover),
            ),
            child: Stack(
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        '서울·2km 거리에 있음',
                        style: TextStyle(
                            fontSize: 15, color: Constants.textCardGrey),
                      ),
                      const SizedBox(
                        height: 40,
                      ),
